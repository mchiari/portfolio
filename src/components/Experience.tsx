	...
	return (
		...
		>
			...
			>
				...
				/>
				{/* <ExperienceSection date={'sep, 2021'} title={`NOTARY'S OFFICE`} role={'Public Notary'} place={'São Vicente, Brazil'} description={'Responsible for costumer experience, business success and public service, worked as a Public Notary in 3º Tabelião de Notas de São Vicente, managing civil interests and real estate matters.'} /> */}
				{/* <ExperienceSection date={'dec, 2019'} title={'ATTORNEY'} role={'Independent Practice'} place={'São Paulo, Brazil'} description={'Due to acceptance on Brazilian State Bar (OAB) straight out of Law School, worked as an attorney for digital, corporate, labor and real estate law.'} /> */}
				<ExperienceSection
